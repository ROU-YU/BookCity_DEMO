...
export default defineComponent({  //如果要使用typeScript 寫法，需從vue導入 defineComponent、computed
  props: {
    modelValue: {
...
<style lang="scss">
//在沒有全局引入文件的情況下，如需使用@extend須確保已有導入相對應的文件 或 添加!optional
.gdb-switch {
  $self: &;
  ...
  &__switch {
    ...
    background-color: map-get($theme-colors, white); //$變數 
